...
public class LearnTestNG {
		...
		public void addCustomer() {
			...
			//WebElement NAME_INPUT_ELEMENT = driver.findElement(By.xpath("//input[@id='account']"));
			//WebElement COMPANY_DROP_DOWN = driver.findElement(By.xpath("//select[@id=\"cid\"]"));
			...
			int randome = rnd.nextInt(999);
			
			EMAIL_INPUT_ELEMENT.sendKeys(randome+email);
